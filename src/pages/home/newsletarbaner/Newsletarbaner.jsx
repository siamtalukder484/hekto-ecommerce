  ...
  return (
    <section className='w-[100%] h-[462px] relative'>
        ...
        <div className='max-w-container mx-auto'>
            <div className='mt-[74px] mb-[103px] w-[574px] mx-auto text-center absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]'>
                <Subheading text="Get Leatest Update By Subscribe 0ur Newslater" style='text-[35px] text-[#151875] font-[700] font-Josefin mb-[28px] capitalize' />  
