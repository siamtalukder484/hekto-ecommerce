    ...
    <section className='py-[15px] bg-[#F2F0FF] relative'>
        <div className='max-w-container mx-auto'>
            <div className='flex items-center justify-between relative'>
                ...
                <div>
                    <Subheading text='Unique Features Of leatest & Trending Poducts' style='w-[627px] leading-[150%] mb-[29px] text-[53px] text-[#151875] font-[600] font-Josefin'/>
                    <div className='flex justify-left gap-y-[13px] flex-col'>
                        <div className='flex items-center justify-left gap-x-[17px]'>
                            ...
                            <Peras text='All frames constructed with hardwood solids and laminates' style='w-[457px]  text-[16px] text-[#ACABC3] font-[700] font-lato leading-[180%]'/>
                        </div>
                        <div className='flex items-center justify-left gap-x-[17px]'>
                    ...
                    <div className='flex items-center justify-left gap-x-[19px] mt-[23px]'>
                        ...
                        <div >
                            <Nanohead text='B&B Italian Sofa ' style='text-[14px] text-[#151875] font-[400] font-Josefin mb-[3px]'/>
                            <span className='text-[14px] text-[#151875] font-[400] font-lato'>$32.00</span>
                        </div>
                    </div>
                </div>
