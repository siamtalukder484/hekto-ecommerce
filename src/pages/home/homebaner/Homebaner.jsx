...
const Homebaner = () => {
  return (
    <section className='pt-[39px] pb-[36px] bg-[#F2F0FF] relative'>
      <div className='w-[180px] h-[350px] absolute left-[160px] top-[0]'>
        ...
        <div className='max-w-container mx-auto'>
            <div className='flex items-center justify-between gap-x-[22px] relative'>
                <div>
                    <Peras text='Best Furniture For Your Castle....' style=' w-[260px] capitalize  text-[16px] text-[red] font-[700]'/>
                    <Headingtext text='New Furniture Collection Trends in 2024' style='w-[664px] leading-[150%] mt-[12px] mb-[12px] text-[53px] text-[black] font-[700]'/>
                    <Peras text='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.' style='w-[600px]  text-[16px] text-[#8A8FB9] font-[700] mb-[43px] leading-[180%]'/>
                ...
                <div className='flex items-center justify-center w-[100px] h-[100px] text-[37px] text-[#fff] rounded-[50%] bg-[#00C1FE] leading-[150%] absolute right-[-30px] top-[0] z-10'>
                  <Miniheadingtext text='50% off' style='w-[69px] text-[27px] text-[#fff] text-center font-[700] mx-auto leading-[150%]'/>
                </div>
            </div>
        </div>
    </section>
