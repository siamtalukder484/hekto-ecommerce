        ...
        <div className='max-w-container mx-auto'>
            <div className='leatest_blog_contant_box'>
                <div className='text-center mb-[80px]'>
                    <Subheading text="Leatest Blog" style="text-[42px] text-[#151875] font-[700] font-Josefin capitalize "/>
                </div>
                                ...
                                <div className='bg-[#fff] pt-[19px] pb-[14px]'>
                                    <div className='flex item-center justify-left gap-x-[29px] pb-[31px]'>
                                        <div className='flex items-center justify-left gap-x-[2px]'>
                                            ...
                                            <Nanohead text={item.casname} style='text-[14px] text-[#151875] font-[400] font-Josefin '/>
                                        </div>
                                        <div className='flex items-center justify-left gap-x-[2px]'>
                                            <div className='w-[20px] h-[20px]'>
                                                <FaCalendarDays className='text-[#FFA454] w-[100%] h-100%] ' />
                                            </div>
                                            <Nanohead text={item.date} style='text-[14px] text-[#151875] font-[400] font-Josefin '/>
                                        </div>
                                    </div>
                                    <Nanohead text={item.name} style='text-[18px] text-[#151875] font-[700] font-Josefin capitalize mb-[17px] transition-all ease-linear delay-0.3s hover:text-[#FB2E86] '/>
                                    <Peras text={item.pera} style=" w-[310px] text-[center] text-[#72718F] text-[16px] font-[400] font-lato leading-[180%]"/>
                                    <div className='leatest_blog_link_box mt-[17px]'>
                                        <Link className='text-[16px] text-[#151875] font-[400] font-lato cursor-pointer underline decoration-[#151875] transition-all ease-linear delay-0.3s hover:text-[#FB2E86] hover:underline hover:decoration-[#FB2E86] ' to={item.link}>{item.linkname}</Link>
                                    </div>
                                </div>
                            </div>
                        ))
